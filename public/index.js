		...
		if (data.length) {
			...
			for (var count = 0; count < data.length; count++) {
				...
				if (data[count].country == 'US') {
					flagString = '<img style="vertical-align:middle; border:1px solid" src="http://18.218.147.148:8080/state/' + data[count].state.toLowerCase() + '.png">';
				} else if (data[count].country != null){
					flagString = '<img style="vertical-align:middle; border:1px solid" src="http://18.218.147.148:8080/country/' + data[count].country.toLowerCase() + '.png">';
				}
